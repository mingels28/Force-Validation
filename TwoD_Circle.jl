...
""" geometry function """
function circle(p=8;Re=1000,U=1,mem=Array,ϵ=0.1)
    n = 2^p                     #number of grid points
    L = n/20                    #characteristic geometry size
    center = SA[n/2,n/2]        #center of 2D domain    
    ...
    #2D simulation
    WaterLily.Simulation((2n,n),(U,0),L;U,ν=U*L/Re,
...
sim  = circle(p;Re=Re,mem=CUDA.CuArray); 
